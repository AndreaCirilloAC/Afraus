...
# apply function to dataset values
data$control_score <- sapply(data[,2],FUN=control_scoring,upper_control_limit=UCL,
                            lower_control_limit= LCL,central_limit=central_limit)
